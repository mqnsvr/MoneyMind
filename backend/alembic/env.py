...
# Pfad setzen, damit "app" importierbar ist
...
def run_migrations_online():
    ...
    # Get alembic.ini config section and override URL with settings
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            compare_type=True  # Wichtig für Änderungen an Spaltentypen
        )
